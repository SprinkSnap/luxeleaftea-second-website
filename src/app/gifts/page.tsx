...
export const metadata = createMetadata({
  title: "Tea Gift Sets — Premium Loose Leaf Gifts",
  description:
    "Gift-worthy premium loose-leaf teas and discovery sets from Lux Leaf Tea. Elegant, approachable, ready to give.",
  path: "/gifts",
});
    ...
    <div className="container-wide px-4 py-10 md:py-14">
      <div className="max-w-2xl">
        ...
        <p className="mt-3 text-brand-muted">
          ...
          for yourself. Add a gift message at checkout.
        </p>
      </div>
      {bundles.length > 0 && (
